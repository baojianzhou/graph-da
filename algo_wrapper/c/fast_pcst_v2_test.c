...
void print_result(Array *result_nodes, Array *re_edges, int number) {
    qsort(re_edges->array, (size_t) re_edges->size, sizeof(int), comp);
    ...
    printf("\nedges: ");
    for (int i = 0; i < re_edges->size; i++) {
        printf(" %d", re_edges->array[i]);
    }
    printf("\n");
}

int _is_passed(Array *re_nodes, Array *re_edges, const int *_result_nodes,
               const int *_re_edges, int n_, int m_) {
    for (int i = 0; i < re_nodes->size; i++) {
        if (re_nodes->array[i] != _result_nodes[i]) {
            return 0;
        }
    }
    if (re_nodes->size != n_) {
    ...
    for (int i = 0; i < re_edges->size; i++) {
        if (re_edges->array[i] != _re_edges[i]) {
            return 0;
        }
    }
    printf("test passed!\n");
...
int test_1() {
    ...
    re_nodes->array = malloc(sizeof(int) * n);
    Array *re_edges = malloc(sizeof(Array));
    re_edges->array = malloc(sizeof(int) * n);
    int _result_nodes[] = {0, 1, 2}, _re_edges[] = {0, 1};;
    int edge_u[] = {0, 1};
    int edge_v[] = {1, 2};
    ...
    double prizes[] = {0., 5., 6.};
    double costs[] = {3., 4.};
    pcst(edges, prizes, costs, root, target_num_active_clusters, eps, pruning,
         n, m, verbose, re_nodes, re_edges);
    print_result(re_nodes, re_edges, 1);
    return _is_passed(re_nodes, re_edges, _result_nodes, _re_edges, 3, 2);
}
...
int test_2() {
    ...
    Array *re_edges = malloc(sizeof(Array));
    re_edges->array = malloc(sizeof(int) * n);
    int _result_nodes[] = {1, 2}, _re_edges[] = {1};;
    ...
    pcst(edges, prizes, costs, root, target_num_active_clusters, eps, pruning,
         n, m, verbose, re_nodes, re_edges);
    print_result(re_nodes, re_edges, 2);
    return _is_passed(re_nodes, re_edges, _result_nodes, _re_edges,
                      2, 1);
}
...
int test_3() {
    ...
    pcst(edges, prizes, costs, root, target_num_active_clusters, eps, pruning,
         n, m, verbose, re_nodes, re_edges);
    print_result(re_nodes, re_edges, 3);
    return _is_passed(re_nodes, re_edges, _re_nodes, _re_edges, 2, 1);
}
...
int test_4() {
    ...
    pcst(edges, prizes, costs, root, target_num_active_clusters, eps, pruning,
         n, m, verbose, re_nodes, re_edges);
    print_result(re_nodes, re_edges, 4);
    return _is_passed(re_nodes, re_edges, _re_nodes, _re_edges, 2, 1);
}
...
int test_5() {
    ...
    double eps = 1e-6;
    Array *re_nodes = malloc(sizeof(Array));
    re_nodes->array = malloc(sizeof(int) * 4);
    Array *re_edges = malloc(sizeof(Array));
    re_edges->array = malloc(sizeof(int) * 4);
    int edge_u[] = {0, 1, 2}, edge_v[] = {1, 2, 3};
    int _re_nodes[] = {0, 1, 2, 3}, _re_edges[] = {1, 2};;
    EdgePair *edges = malloc(sizeof(EdgePair) * m);
    for (int i = 0; i < m; i++) {
        edges[i].first = edge_u[i];
        edges[i].second = edge_v[i];
    ...
    pcst(edges, prizes, costs, root, target_num_active_clusters, eps, pruning,
         n, m, verbose, re_nodes, re_edges);
    print_result(re_nodes, re_edges, 5);
    return _is_passed(re_nodes, re_edges, _re_nodes, _re_edges, 4, 2);
}
...
int test_6() {
    ...
    int _re_nodes[] = {0}, _re_edges[] = {};
    double prizes[] = {10., 0., 1., 10.};
    double costs[] = {10., 4., 3.};
    pcst(edges, prizes, costs, root, target_num_active_clusters, eps, pruning,
         n, m, verbose, re_nodes, re_edges);
    print_result(re_nodes, re_edges, 6);
    return _is_passed(re_nodes, re_edges, _re_nodes, _re_edges, 1, 0);
}
...
int test_7() {
    ...
    int _re_nodes[] = {0, 1, 2, 3}, _re_edges[] = {0, 1, 2};
    double prizes[] = {10., 10., 1., 10.};
    double costs[] = {10., 6., 5.};
    pcst(edges, prizes, costs, root, target_num_active_clusters, eps, pruning,
         n, m, verbose, re_nodes, re_edges);
    print_result(re_nodes, re_edges, 7);
    return _is_passed(re_nodes, re_edges, _re_nodes, _re_edges, 4, 3);
}
...
int test_8() {
    ...
    pcst(edges, prizes, costs, root, target_num_active_clusters, eps, pruning,
         n, m, verbose, re_nodes, re_edges);
    print_result(re_nodes, re_edges, 8);
    return _is_passed(re_nodes, re_edges, _re_nodes, _re_edges, 4, 3);
}
...
int test_9() {
    ...
    int _re_nodes[] = {0, 1, 2}, _re_edges[] = {1};
    double prizes[] = {10., 3., 3.};
    double costs[] = {100., 2.};
    pcst(edges, prizes, costs, root, target_num_active_clusters, eps, pruning,
         n, m, verbose, re_nodes, re_edges);
    print_result(re_nodes, re_edges, 9);
    return _is_passed(re_nodes, re_edges, _re_nodes, _re_edges, 3, 1);
}
...
int test_10() {
    ...
    pcst(edges, prizes, costs, root, target_num_active_clusters, eps, pruning,
         n, m, verbose, re_nodes, re_edges);
    print_result(re_nodes, re_edges, 10);
    return _is_passed(re_nodes, re_edges, _re_nodes, _re_edges, 1, 0);
}
...
int test_11() {
    ...
    pcst(edges, prizes, costs, root, target_num_active_clusters, eps, pruning,
         n, m, verbose, re_nodes, re_edges);
    print_result(re_nodes, re_edges, 11);
    return _is_passed(re_nodes, re_edges, _re_nodes, _re_edges, 3, 1);
}
...
int test_12() {
    ...
    pcst(edges, prizes, costs, root, target_num_active_clusters, eps, pruning,
         n, m, verbose, re_nodes, re_edges);
    print_result(re_nodes, re_edges, 12);
    return _is_passed(re_nodes, re_edges, _re_nodes, _re_edges, 1, 0);
}
...
int test_13() {
    ...
    int _re_nodes[] = {0, 2, 3}, _re_edges[] = {2};
    double prizes[] = {10., 0., 6., 6.};
    double costs[] = {100., 2., 5.};
    pcst(edges, prizes, costs, root, target_num_active_clusters, eps, pruning,
         n, m, verbose, re_nodes, re_edges);
    print_result(re_nodes, re_edges, 13);
    return _is_passed(re_nodes, re_edges, _re_nodes, _re_edges, 3, 1);
}
...
int test_14() {
    ...
    int _re_nodes[] = {3, 4, 6, 7, 8}, _re_edges[] = {16, 20, 21, 23};
    ...
    pcst(edges, prizes, costs, root, target_num_active_clusters, eps, pruning,
         n, m, verbose, re_nodes, re_edges);
    print_result(re_nodes, re_edges, 14);
    return _is_passed(re_nodes, re_edges, _re_nodes, _re_edges, 5, 4);
}
...
int test_15() {
    ...
    int _re_nodes[] = {0, 1, 2, 3, 4, 5, 6, 7};
    int _re_edges[] = {0, 1, 2, 3, 4, 5, 6};
    ...
    pcst(edges, prizes, costs, root, target_num_active_clusters, eps, pruning,
         n, m, verbose, re_nodes, re_edges);
    print_result(re_nodes, re_edges, 15);
    return _is_passed(re_nodes, re_edges, _re_nodes, _re_edges, 8, 7);
}
...
int test_16() {
    ...
    pcst(edges, prizes, costs, root, target_num_active_clusters, eps, pruning,
         n, m, verbose, re_nodes, re_edges);
    print_result(re_nodes, re_edges, 16);
    return _is_passed(re_nodes, re_edges, _re_nodes, _re_edges, 1, 0);
}
...
int test_17() {
    ...
    int _re_nodes[] = {0, 1, 2, 3, 4}, _re_edges[] = {0, 1, 2, 3};
    double prizes[] = {0., 2.2, 0.0, 0.0, 2.1};
    double costs[] = {1.0, 1.0, 1.0, 1.0};
    double eps = 1e-6;
    PruningMethod pruning = GWPruning;
    ...
    pcst(edges, prizes, costs, root, target_num_active_clusters, eps, pruning,
         n, m, verbose, re_nodes, re_edges);
    print_result(re_nodes, re_edges, 17);
    return _is_passed(re_nodes, re_edges, _re_nodes, _re_edges, 5, 4);
}
...
int test_18() {
    ...
    pcst(edges, prizes, costs, root, target_num_active_clusters, eps, pruning,
         n, m, verbose, re_nodes, re_edges);
    print_result(re_nodes, re_edges, 18);
    return _is_passed(re_nodes, re_edges, _re_nodes, _re_edges, 2, 1);
}
...
void test_stp_instance(char *file_name, char *index, int *n_, int *m_,
    ...
    pcst(edges, prizes, costs, root, target_num_active_clusters, eps, pruning,
         n, m, 0, re_nodes, re_edges);
    clock_t end = clock();
    double time_spent = (double) (end - begin) / 1000.;
    qsort(re_edges->array, (size_t) re_edges->size, sizeof(int), comp);
    qsort(re_nodes->array, (size_t) re_nodes->size, sizeof(int), comp);
    printf("id:%s number of nodes: %d number of edges: %d, runt_time:%.6f\n",
           index, re_nodes->size, re_edges->size, time_spent);
    *n_ = n;
    *m_ = m;
...
void test_table_1_pcspg_actmodpc() {
    ...
    char file_name[100];
    char *root_path = "/network/rit/lab/ceashpc/bz383376/data/pcst/PCSPG-ACTMODPC/";
...
void test_on_mnist_data() {
    ...
    for (int ii = 0; ii < 10; ii++) {
        ...
        pcst(edges, prizes, costs, root, target_num_active_clusters, eps,
             pruning, n, m, 0, re_nodes, re_edges);
        double run_time = (double) (clock() - start_time) / CLOCKS_PER_SEC;
        printf("number of re_nodes: %d re_edges: %d run_time: %.4f\n",
               re_nodes->size, re_edges->size, run_time);
    }
}
