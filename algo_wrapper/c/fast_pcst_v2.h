...
#ifndef ONLINE_OPT_FAST_PCST_V2_H
#define ONLINE_OPT_FAST_PCST_V2_H
...
void get_sum_on_edge_part(PCST *pcst, int edge_part_ind, double *total_sum,
...
#endif //ONLINE_OPT_FAST_PCST_V2_H
